...
import { PdfViewerDemo } from '../screens/pdf-viewer';
import { ChartProDemo } from '../chart-pro-demos';
import { useState } from 'react';
import { Checkbox, Select, Stack, Text } from '@mega_ui/react';
import { DataGridPro, type GridColumn } from '@mega_ui/react/data-grid';
import { TextEditor } from '@mega_ui/react/text-editor';
import { CartesianChart, PieChart } from '@mega_ui/react/charts';
    ...
    <div className="professional-category">
      <CategoryCards
        ...
        notes={{
          PdfViewerPro: (
            <>
              <a href="./pdf-viewer.md">문서 뷰어 API</a> ·{' '}
              <a href="#pdf-viewer?full=1">문서 검토 전체 예제 열기</a>
            </>
          ),
          SpreadsheetPro: (
            <>
